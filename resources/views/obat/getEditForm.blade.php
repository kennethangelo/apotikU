<form role="form" action="{{route('obat.update', $data->id)}}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" placeholder="Masukkan nama" value="{{$data->nama_obat}}">
            </div>
            <div class="form-group">
                <label for="stok">Stok</label>
                <input type="number" class="form-control" name="stok" placeholder="Masukkan stok" value="{{$data->stok}}">
            </div>
            <div class="form-group">
